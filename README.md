...
This portfolio is a **Next.js port** of the original Vue 3 implementation by **Ebraheem Alhetari (hetari)**.
...
- [**GSAP**](https://greensock.com/gsap/) + [@gsap/react](https://gsap.com/docs/v3/React/)
