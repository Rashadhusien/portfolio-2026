export function Star({ className, id }: { className?: string; id?: string }) {
  return (
    <div id={id} className={className}>
      ...
      <span>
        <svg
          ...
          className="hide heading-size inline-block animate-[spin_5s_linear_infinite] fill-flax-smoke-900"
          viewBox="0 0 75 76"
          fill="none"
